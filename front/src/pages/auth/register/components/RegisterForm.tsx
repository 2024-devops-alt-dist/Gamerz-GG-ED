...
const RegisterForm = () => {
    ...
    return (
        <>
            ...
            <Card className="w-full max-w-md mx-auto p-6 sm:p-10 mt-5 shadow-lg rounded-lg">
                <CardHeader>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                                ...
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input
                                            ...
                                            placeholder="Nom"
                                            {...field}
                                            className="w-full bg-background border border-gray-600 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 rounded-md px-4 py-2 transition-all"
                                        />
                                    </FormControl>
                        ...
                        <Button
                            className="w-full bg-green-600 hover:bg-green-700 transition-all py-2 rounded-md  font-semibold">
                            S'inscrire
                        </Button>
