            ...
            <div className="max-w-6xl mx-auto py-10 px-4 grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2 space-y-6">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">View and update your account details, profile and
                            more.</p>
                    </div>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                ...
                                                <FormMessage/>
                                                <p className="text-xs text-muted-foreground">Minimum 11 caractères avec
                                                    majuscule, minuscule, chiffre et caractère spécial.</p>
                                            </FormItem>
                                        )}
                                    />
                                    <FormField
